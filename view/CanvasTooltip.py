...
# Source: https://stackoverflow.com/questions/40538204/
# how-i-can-make-a-tooltip-appear-over-a-canvas-area-bounded-by-a-box/41080067#41080067
...
class CanvasTooltip:
    ...
    def show(self, event=None):
        ...
        label = ttk.Label(win,
                          ...
                          background=bg,
                          relief=tk.SOLID,
                          font=tkFont.Font(family="Lucida Console"),
                          borderwidth=0,
